...
struct WatchProgress: Codable, Identifiable, Hashable { let releaseID: Int; let episodePosition: Int; let sourceID: Int; let seconds: Double; let duration: Double; let updatedAt: Date; var id: String { "\(releaseID)-\(episodePosition)-\(sourceID)" } }
